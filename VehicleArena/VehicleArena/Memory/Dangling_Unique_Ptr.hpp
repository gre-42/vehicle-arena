...
template <class T>
inline std::unordered_map<const void*, ::VA::PointedSourceLocation>& locs() {
...
#define DP_IMPLEMENT(T)                                                                 \
    template <>                                                                         \
    std::unordered_map<const void*, ::VA::PointedSourceLocation>& VA::locs_<T>() {  \
        static std::unordered_map<const void*, ::VA::PointedSourceLocation> result;   \
        return result;                                                                  \
    }                                                                                   \
    template <>                                                                         \
    ::VA::SafeAtomicSharedMutex& ::VA::loc_mutex_<T>() {                            \
...
template <class T>
struct hash<VA::DanglingPtr<T>>
{
    std::size_t operator()(const VA::DanglingPtr<T>& s) const noexcept {
