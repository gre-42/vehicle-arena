...
#include <VehicleArena/Geography/Geographic_Coordinates.hpp>
#include <VehicleArena/Geometry/Coordinates/Gl_Look_At.hpp>
#include <VehicleArena/Geometry/Coordinates/Homogeneous.hpp>
#include <VehicleArena/Geometry/Coordinates/Rotate_Axis_Onto_Other_Axis.hpp>
...
#include <VehicleArena/Physics/Actuators/Rigid_Body_Delta_Engine.hpp>
#include <VehicleArena/Physics/Actuators/Rigid_Body_Engine.hpp>
#include <VehicleArena/Physics/Actuators/Rotor.hpp>
#include <VehicleArena/Physics/Actuators/Tire.hpp>
#include <VehicleArena/Physics/Actuators/Tire_Power_Intent.hpp>
#include <VehicleArena/Physics/Actuators/Wing.hpp>
#include <VehicleArena/Physics/Ai/Skill_Factor.hpp>
...
#include <VehicleArena/Physics/Interfaces/ICollision_Normal_Modifier.hpp>
#include <VehicleArena/Physics/Interfaces/IDamageable.hpp>
#include <VehicleArena/Physics/Interfaces/IPlayer.hpp>
#include <VehicleArena/Physics/Interfaces/ISpawner.hpp>
...
#include <VehicleArena/Physics/Vehicle_Controllers/Avatar_Controllers/Rigid_Body_Avatar_Controller.hpp>
...
// namespace VA { thread_local extern std::list<Beacon> g_beacons; }
    ...
    const StaticWorld& world)
{
    ...
    if (grind_state_.grinding_) {
        ...
        if ((align_to_surface_state_.align_to_surface_relaxation_ != 0) &&
            !all(VA::isnan(align_to_surface_state_.surface_normal_)))
        {
            if (!all(rbp_.w_ == 0.f)) {
