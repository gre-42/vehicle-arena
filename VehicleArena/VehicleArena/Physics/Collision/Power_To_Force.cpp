 ...
 */
void VA::power_to_forces_finite_masses(
...
FixedArray<float, 3> VA::min_l2(const FixedArray<float, 3>& v, float max_length) {
 ...
 * P == NAN => brake
 */
VA::FixedArray<float, 3> VA::power_to_force_infinite_mass(
    float brake_force,
    ...
    bool avoid_burnout)
{
    ...
    VA::FixedArray<float, 3> normal_force = uninitialized;
...
VA::FixedArray<float, 3> VA::friction_force_infinite_mass(
    float max_stiction_force,
    float friction_force,
    const FixedArray<float, 3>& v3,
    float alpha0)
 ...
 * d -> n => dTd = 1
 */
VA::FixedArray<float, 3> power_to_force_infinite_mass_3D(
    float break_accel,
    const FixedArray<float, 3>& power3,
    float m,
    const FixedArray<float, 3>& v3,
