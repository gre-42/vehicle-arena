...
#include <VehicleArena/Geometry/Primitives/Intersectors/Polygon_Line_Intersector.hpp>
#include <VehicleArena/Physics/Collision/Grind_Info.hpp>
#include <VehicleArena/Physics/Collision/Record/Collision_History.hpp>
#include <VehicleArena/Physics/Collision/Record/Handle_Reflection.hpp>
...
void VA::handle_line_triangle_intersection(const IntersectionScene& c)
{
    if (&c.o0 == &c.o1) {
...
void VA::handle_line_triangle_intersection(
    ...
    const IntersectionInfo& iinfo)
{
    ...
    if (collision_type == CollisionType::GO_THROUGH) {
        ...
        if (!any(VA::isnan(c.o0.grind_state_.grind_direction_))) {
