...
#include <VehicleArena/Remote/Remote_Role.hpp>
...
void VA::from_json(const nlohmann::json& j, RemoteParams& params) {
    JsonView jv{ j };
...
void VA::to_json(nlohmann::json& j, const RemoteParams& params) {
