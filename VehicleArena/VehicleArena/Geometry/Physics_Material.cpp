...
PhysicsMaterial VA::physics_material_from_string(const std::string& s) {
...
std::string VA::physics_material_to_string(PhysicsMaterial p) {
...
void VA::from_json(const nlohmann::json& j, PhysicsMaterial& p) {
