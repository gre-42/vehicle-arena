...
#include <VehicleArena/Geometry/Mesh/Ambient_Occlusion_By_Curvature.hpp>
...
#include <VehicleArena/Geometry/Primitives/Point_Triangle_Intersection.hpp>
#include <VehicleArena/Geometry/Static_Face_Lighting.hpp>
#include <VehicleArena/Geometry/Triangle_Normal.hpp>
#include <VehicleArena/Geometry/Triangle_Tangent.hpp>
#include <VehicleArena/Math/Orderable_Fixed_Array.hpp>
#include <VehicleArena/Os/Os.hpp>
#include <VehicleArena/Osm_Loader/Osm_Map_Resource/Vertex_Height_Binding.hpp>
#include <VehicleArena/Scene_Config/Scene_Precision.hpp>
#include <VehicleArena/Threads/Thread_Top.hpp>
    ...
    float strength)
{
    ...
    VA::ambient_occlusion_by_curvature(cvl, strength);
}
