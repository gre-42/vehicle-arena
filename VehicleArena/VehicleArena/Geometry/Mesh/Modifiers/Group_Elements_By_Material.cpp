...
template <class TPos>
std::list<std::shared_ptr<ColoredVertexArray<TPos>>> VA::group_elements_by_material(
...
template std::list<std::shared_ptr<ColoredVertexArray<float>>>
    VA::group_elements_by_material(const std::list<std::shared_ptr<ColoredVertexArray<float>>>& cvas);
template std::list<std::shared_ptr<ColoredVertexArray<CompressedScenePos>>>
    VA::group_elements_by_material(const std::list<std::shared_ptr<ColoredVertexArray<CompressedScenePos>>>& cvas);
