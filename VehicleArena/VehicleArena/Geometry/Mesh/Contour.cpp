...
#include <VehicleArena/Geometry/Mesh/Contour_Detection_Strategy.hpp>
#include <VehicleArena/Geometry/Mesh/Plot.hpp>
#include <VehicleArena/Math/Orderable_Fixed_Array.hpp>
#include <VehicleArena/Os/Env.hpp>
...
std::unordered_set<std::pair<OrderableFixedArray<TPos, 3>, OrderableFixedArray<TPos, 3>>>
    VA::find_contour_edges(const std::list<const FixedArray<ColoredVertex<TPos>, 3>*>& triangles)
{
...
template <class TPos>
std::unordered_set<std::pair<OrderableFixedArray<TPos, 3>, OrderableFixedArray<TPos, 3>>>
    VA::find_contour_edges(const std::list<FixedArray<ColoredVertex<TPos>, 3>*>& triangles)
{
...
template <class TPos>
std::list<std::list<FixedArray<TPos, 3>>> VA::find_contours(
...
std::unordered_set<std::pair<OrderableFixedArray<float, 3>, OrderableFixedArray<float, 3>>>
    VA::find_contour_edges(const std::list<const FixedArray<ColoredVertex<float>, 3>*>& triangles);

template
std::unordered_set<std::pair<OrderableFixedArray<float, 3>, OrderableFixedArray<float, 3>>>
    VA::find_contour_edges(const std::list<FixedArray<ColoredVertex<float>, 3>*>& triangles);

template
std::list<std::list<FixedArray<float, 3>>> VA::find_contours(
...
std::unordered_set<std::pair<OrderableFixedArray<CompressedScenePos, 3>, OrderableFixedArray<CompressedScenePos, 3>>>
    VA::find_contour_edges(const std::list<const FixedArray<ColoredVertex<CompressedScenePos>, 3>*>& triangles);

template
std::unordered_set<std::pair<OrderableFixedArray<CompressedScenePos, 3>, OrderableFixedArray<CompressedScenePos, 3>>>
    VA::find_contour_edges(const std::list<FixedArray<ColoredVertex<CompressedScenePos>, 3>*>& triangles);

template
std::list<std::list<FixedArray<CompressedScenePos, 3>>> VA::find_contours(
