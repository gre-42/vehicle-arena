...
std::string VA::joined_way_point_sandbox_to_string(JoinedWayPointSandbox t) {
...
JoinedWayPointSandbox VA::joined_way_point_sandbox_from_string(const std::string& s) {
