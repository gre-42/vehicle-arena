...
#include <VehicleArena/Geometry/Mesh/Save_Obj.hpp>
...
void ISceneNodeResource::instantiate_child_renderable(const ChildInstantiationOptions& options) const {
    throw std::runtime_error("instantiate_child_renderable not implemented");
}

void ISceneNodeResource::instantiate_root_renderables(const RootInstantiationOptions& options) const {
    throw std::runtime_error("instantiate_root_renderables not implemented");
}
...
void ISceneNodeResource::create_barrier_triangle_hitboxes(
    ...
    const ColoredVertexArrayFilter& filter)
{
    throw std::runtime_error("create_barrier_triangle_hitboxes not implemented");
}
...
void ISceneNodeResource::smoothen_edges(
    ...
    float decay)
{
    throw std::runtime_error("smoothen_edges not implemented");
}

AggregateMode ISceneNodeResource::get_aggregate_mode() const {
    throw std::runtime_error("get_aggregate_mode not implemented");
}

PhysicsMaterial ISceneNodeResource::get_physics_material() const {
    throw std::runtime_error("get_physics_material not implemented");
}

std::list<SpawnPoint> ISceneNodeResource::get_spawn_points() const {
    throw std::runtime_error("get_spawn_points not implemented");
}

WayPointSandboxes ISceneNodeResource::get_way_points() const {
    throw std::runtime_error("get_way_points not implemented");
}
