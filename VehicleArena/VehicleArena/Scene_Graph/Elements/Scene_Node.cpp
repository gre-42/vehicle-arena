...
#include <VehicleArena/Iterator/Un_Guarded_Iterator.hpp>
#include <VehicleArena/Math/Fixed_Math.hpp>
#include <VehicleArena/Math/Fixed_Rodrigues.hpp>
#include <VehicleArena/Math/Transformation/Bijection.hpp>
...
#include <VehicleArena/Scene_Config/Interpolation_Thresholds.hpp>
...
#include <VehicleArena/Scene_Graph/Containers/List_Of_Blended.hpp>
...
#include <VehicleArena/Scene_Graph/Elements/Light.hpp>
...
#include <VehicleArena/Scene_Graph/Elements/Skidmark.hpp>
#include <VehicleArena/Scene_Graph/Interfaces/IDynamic_Lights.hpp>
#include <VehicleArena/Scene_Graph/Interfaces/IParticle_Renderer.hpp>
#include <VehicleArena/Scene_Graph/Interfaces/IRenderable_Scene.hpp>
...
#include <VehicleArena/Scene_Graph/Interfaces/Scene_Node/INode_Hider.hpp>
...
#include <VehicleArena/Threads/Throwing_Defer_Lock_Guard.hpp>
...
std::ostream& VA::operator << (std::ostream& ostr, DanglingBaseClassPtr<const SceneNode> node) {
    if (node != nullptr) {
        node->print(ostr);
    } else {
        ostr << "<null node>\n";
