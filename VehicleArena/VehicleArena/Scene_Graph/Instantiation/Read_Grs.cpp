...
Model VA::Grs::load_grs(std::istream& istr, IoVerbosity verbosity) {
    Model result;
...
Model VA::Grs::load_grs(const std::string& filename, IoVerbosity verbosity) {
