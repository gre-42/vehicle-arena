...
#include <VehicleArena/Geography/Altitude_Azimuth.hpp>
#include <VehicleArena/Geography/Idl_Mod.hpp>
#include <VehicleArena/Geography/Local_Mean_Sidereal_Time.hpp>
#include <VehicleArena/Geography/Season.hpp>
...
TData VA::days_since_noon_2000_1_1(const std::chrono::system_clock::time_point& time) {
    using namespace std::chrono;
...
// FixedArray<TData, 3> VA::sun_direction(
...
template <class TData>
std::chrono::system_clock::time_point VA::time_of_season(
    Season season,
