...
void VA::svd4(const Array<double>& a, Array<double>& u, Array<double>& s, Array<double>& vT) {
...
double VA::cond4(const Array<double>& a) {
    assert(a.shape(0) >= a.shape(1));
...
double VA::cond4_x(const Array<double>& a) {
    assert(a.shape(0) >= a.shape(1));
...
Array<double> VA::eig4(const Array<double>& a) {
    Array<double> u;
    Array<double> s;
    Array<double> vT;
    svd4(a, u, s, vT);
