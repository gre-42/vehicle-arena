...
#include <VehicleArena/Math/Eigen_Jacobi_Generic.hpp>

using namespace Mlib;

void VA::eigs_symm(const Array<double>& m, Array<double>& evals, Array<double>& evecs) {
    assert(m.ndim() == 2);
...
Array<double> VA::eigs_symm(const Array<double>& m) {
    Array<double> evals;
    Array<double> evecs;
