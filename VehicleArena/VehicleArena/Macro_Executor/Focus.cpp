...
#include <VehicleArena/Macro_Executor/Focus_Filter.hpp>
#include <VehicleArena/Os/Os.hpp>
#include <VehicleArena/Regex/Regex_Select.hpp>
#include <VehicleArena/Strings/String.hpp>
#include <VehicleArena/Threads/Containers/Thread_Safe_String_Json.hpp>
#include <algorithm>
#include <iostream>
#include <stdexcept>
...
std::ostream& VA::operator << (std::ostream& ostr, const Focuses& focuses) {
...
Focus VA::single_focus_from_string(const std::string& str) {
...
Focus VA::focus_from_string(const std::string& s) {
...
std::string VA::focus_to_string(Focus focus) {
    std::string result;
