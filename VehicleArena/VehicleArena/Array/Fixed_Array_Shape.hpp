...
public:
    ...
    consteval static auto concatenated(const FixedArrayShape<tsize_b...>& b) { return ::VA::FasUtils::concatenated(A(), b); }
...
template <size_t... tsize>
consteval auto FixedArrayShape<tsize...>::erased_first() { return ::VA::FasUtils::erased_first(A()); }

template <size_t... tsize>
consteval auto FixedArrayShape<tsize...>::erased_last() { return ::VA::FasUtils::erased_last(A()); }

template <size_t... tsize>
consteval auto FixedArrayShape<tsize...>::last() { return ::VA::FasUtils::last(A()); }

template <size_t... tsize>
consteval auto FixedArrayShape<tsize...>::nelements() { return ::VA::FasUtils::nelements(A()); }

template <size_t... tsize>
consteval auto FixedArrayShape<tsize...>::ndim() { return ::VA::FasUtils::ndim(A()); }

template <size_t... tsize>
consteval auto FixedArrayShape<tsize...>::rows_as_1D() { return ::VA::FasUtils::rows_as_1D(A()); }

template <size_t... tsize>
consteval auto FixedArrayShape<tsize...>::columns_as_1D() { return ::VA::FasUtils::columns_as_1D(A()); }

template <size_t... tsize>
template <size_t axis>
consteval auto FixedArrayShape<tsize...>::axis_as_3D() { return ::VA::FasUtils::axis_as_3D<axis>(A()); }

template <size_t... tsize>
template <size_t axis>
consteval auto FixedArrayShape<tsize...>::without_axis() { return ::VA::FasUtils::without_axis<axis>(A()); }

template <size_t... tsize>
template <size_t N>
consteval size_t FixedArrayShape<tsize...>::get() { return ::VA::ElemUtils::NthElement<N, tsize...>::value; }
